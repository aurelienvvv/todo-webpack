...
describe('controller', function () {
	...
	it('test si quelque chose est true ou pas', function () {
	...
	describe('routing', function () {
		// Identifie comment il doit se comporter
		it('should show all entries without a route', function () {
			// Situation théorique, on ajout un title à todo
		...
		it('should show active entries', function () {
			...
			// ajout todo au model
			setUpModel([todo]);
			// change la route sur #/active
			subject.setView('#/active');
			// lance la fonction showActive
			subject.showActive();
		...
		it('should show completed entries', function () {
			...
			// change la route sur #/completed
			subject.setView('#/completed');
			
			// lance la fonction showCompleted
	...
	describe('toggle all', function () {
		...
		it('should toggle all todos to completed', function () {
			// TODO: write test
			var todo1 = { id: "aEd7-red4", title: 'my todo 1', completed: true };
			var todo2 = { id: "aEd6-der5", title: 'my todo 2', completed: true };
			var todo3 = { id: "aEd5-aen9", title: 'my todo 3', completed: true };
